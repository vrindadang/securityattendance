...
export const TUESDAY_REMOVED_CUSTOM_IDS = new Set([
  ...
  '1778853476883866', // Devi saran (custom duplicate)
  '1772826322634724', // Shushil sethi (custom duplicate)
  '1771365207896392', // Sushil sethi (custom duplicate)
  '1771623257976988', // Susheel Sethi (custom duplicate)
  '1771622639936830', // Sushil Sethi (custom duplicate)
  '1771623239803526', // Sushil sethi (custom duplicate)
]);
...
export function isRemovedTuesday(sewadarOrName: any): boolean {
  ...
  if (typeof sewadarOrName === 'object') {
    ...
    if (norm === 'DEVISARAN' || norm === 'DEVISARANN') {
      return sewadarOrName.id === '1778853476883866';
    }
    if (norm === 'SUSHILSETHI' || norm === 'SHUSHILSETHI' || norm === 'SUSHEELSETHI') {
      return TUESDAY_REMOVED_CUSTOM_IDS.has(sewadarOrName.id);
    }
    return TUESDAY_REMOVED_NORMS.has(norm);
  }
  const norm = normalizeName(String(sewadarOrName));
  if (norm === 'RAHULGARG' || norm === 'DEVISARAN' || norm === 'DEVISARANN' || norm === 'SUSHILSETHI' || norm === 'SHUSHILSETHI' || norm === 'SUSHEELSETHI') {
    return false;
  }
  return TUESDAY_REMOVED_NORMS.has(norm);
}
...
const LADIES_MONDAY_NIGHT_LIST = [
  "KANTA RANI", "JYOTI KHERA", "SUMAN SETHI", "CHANCHAL HARJAI", "JOLLY", "KAMLESH BHARDWAJ", "KAMLESH VERMA", "KIRAN BALA", "KOSHAL BHUTANI", "MANJU CHAUHAN", "MEENAKSHI", "NEERU BHALLA", "PUSHPA TANEJA", "PUSHPA SINGH", "RENU MALIK", "RESHMA YADAV", "SANTOSH MEHRA", "SHAKUNTLA BABBAR", "SHASHI GAMBHIR", "SUDESH BATRA", "SUDESH ROHILLA", "SUNITA VERMA", "USHA (TIMARPUR)"
];

const LADIES_TUESDAY_DAY_LIST = [
  "GEETA OHRI", "ANITA SETHI", "ANITA MAKKAR", "BABLI", "CHANDER NAINWALL", "DARSHNA DUA", "JOLLY", "JYOTI MALHOTRA", "KAMLESH ARORA", "KANTA GUPTA", "MAHAK CHAWLA", "NEERU CHOPRA", "RENU MANGLAI", "RAM WATI", "RESHMA YADAV"
];
...
const LADIES_THURSDAY_DAY_LIST = [
  "ASHA KAPOOR", "BHARTI UDAR", "CHANDA GUPTA", "JOLLY", "KAMLESH BHARDWAJ",
...
export const PUNJAB_ZONE_GENTS_RAW: RawPunjabSewadar[] = [
  // Page 1
  { name: "Vaishakhi Ram", age: 63, dob: "1963-04-03", phone: "8283800370", district: "Jalandhar" },
  { name: "Ashwani Kashyap", age: 62, dob: "1964-09-21", phone: "8847553723", district: "Jalandhar" },
  { name: "Deepak Kohli", age: 46, dob: "1980-11-02", phone: "9876822210", district: "Jalandhar" },
  { name: "Akaash", age: 23, dob: "2003-01-24", phone: "9914628872", district: "Jalandhar" },
  { name: "Vishal Chhabra", age: 43, dob: "1983-12-20", phone: "9599474218", district: "Jalandhar" },
  { name: "Dalvir Chand", age: 55, dob: "1971-03-15", phone: "8968974319", district: "Jalandhar" },
  { name: "Rajiv Kumar", age: 54, dob: "1972-11-04", phone: "9999446947", district: "Jalandhar" },
  { name: "Rajiv Kumar", age: 49, dob: "1977-12-18", phone: "7888618622", district: "Jalandhar" },
  { name: "Prem Mehra", age: 48, dob: "1977-12-15", phone: "9914948555", district: "Jalandhar" },
  { name: "Surinder Kumar", age: 45, dob: "1981-07-18", phone: "8847078722", district: "Jalandhar" },
  { name: "Tilak Raj", age: 62, dob: "1964-02-09", phone: "9417801355", district: "Jalandhar" },
  { name: "Lakshay Sharma", age: 20, dob: "2006-09-27", phone: "9779680232", district: "Jalandhar" },
  { name: "Anmol Arora", age: 17, dob: "2009-04-15", phone: "9815941400", district: "Jalandhar" },
  { name: "Sushil Kumar", age: 57, dob: "1969-11-01", phone: "9815229224", district: "Jalandhar" },
  { name: "Rajesh Kumar", age: 50, dob: "1974-06-05", phone: "7814348606", district: "Jalandhar" },
  { name: "Raj Kumar", age: 62, dob: "1964-01-13", phone: "9872325340", district: "Jalandhar" },
  { name: "Sanjeev Kumar", age: 55, dob: "1971-01-14", phone: "9878529796", district: "Jalandhar" },
  { name: "Nachhattar Ram", age: 51, dob: "1975-01-17", phone: "8968088916", district: "Jalandhar" },
  { name: "Puneet Dadral", age: 20, dob: "2006-05-20", phone: "6283857449", district: "Jalandhar" },
  { name: "Pankaj", age: 23, dob: "2003-09-27", phone: "9781725072", district: "Jalandhar" },
  { name: "Vinod Saxena", age: 55, dob: "1970-08-15", phone: "9465807472", district: "Faridkot" },
  { name: "Jaswant Singh", age: 46, dob: "1980-09-28", phone: "9417381457", district: "Moga" },
  { name: "Nachhattar Singh", age: 32, dob: "1994-10-23", phone: "8288945030", district: "Moga" },
  { name: "Ved Parkash", age: 62, dob: "1964-08-23", phone: "6283561253", district: "Moga" },
  { name: "Sukhjinder Singh", age: 39, dob: "1987-12-15", phone: "9878229292", district: "Bathinda" },
  { name: "Balvir Singh", age: 66, dob: "1960-12-20", phone: "8334892491", district: "Bathinda" },
  { name: "Resham Singh", age: 68, dob: "1958-06-10", phone: "9876251801", district: "Bathinda" },
  { name: "Ramesh Kumar", age: 74, dob: "1952-09-15", phone: "8826010251", district: "Bathinda" },
  { name: "Harbans Lal", age: 42, dob: "1984-03-29", phone: "9115195551", district: "Bathinda" },
  { name: "Shyam Singh", age: 61, dob: "1966-03-12", phone: "9463040172", district: "Bathinda" },
  { name: "Chand Singh", age: 70, dob: "1956-01-01", phone: "8289053623", district: "Bathinda" },
  { name: "Gurmail Singh", age: 65, dob: "1961-01-01", phone: "9463078765", district: "Bathinda" },
  { name: "Dharminder", age: 48, dob: "1978-01-01", phone: "9855446026", district: "Bathinda" },
  { name: "Harbhajan Singh", age: 61, dob: "1965-01-01", phone: "7508366204", district: "Bathinda" },
  { name: "Chetan Kashyap", age: 39, dob: "1987-01-08", phone: "7652894344", district: "Gurdaspur" },
  { name: "Hoshiar Kashyap", age: 33, dob: "1993-03-14", phone: "6280421600", district: "Gurdaspur" },
  { name: "Parveen Kashyap", age: 39, dob: "1987-01-20", phone: "9041738121", district: "Gurdaspur" },
  { name: "Ravi Hans", age: 33, dob: "1993-02-06", phone: "9780125666", district: "Gurdaspur" },
  { name: "Rehan Kashyap", age: undefined, dob: "", phone: "", district: "Gurdaspur" },
  { name: "Ashish Kashyap", age: undefined, dob: "", phone: "7696351525", district: "Jalandhar" },
  { name: "Sudagar Mal", age: 69, dob: "1957-01-01", phone: "7538522392", district: "Pathankot" },
  { name: "Som Raj", age: 58, dob: "1968-05-01", phone: "7973831325", district: "Pathankot" },
  { name: "Buta Ram", age: 48, dob: "1978-01-01", phone: "7589194527", district: "Pathankot" },
  { name: "Vijay Kumar", age: 53, dob: "1973-01-01", phone: "7837019809", district: "Pathankot" },
  { name: "Raman Kumar", age: 46, dob: "1980-04-04", phone: "9463439236", district: "Pathankot" },
  { name: "Tilak Raj", age: 62, dob: "1964-05-30", phone: "6239321991", district: "Pathankot" },
  { name: "Shammi Kumar", age: 34, dob: "1992-08-15", phone: "6280369347", district: "Pathankot" },
  { name: "Rajesh Kumar", age: 28, dob: "1998-03-17", phone: "6280442026", district: "Pathankot" },
  { name: "Mohinder Pal", age: 60, dob: "1966-07-15", phone: "7814917886", district: "Pathankot" },
  { name: "Ashok Kumar", age: 53, dob: "1973-03-17", phone: "9872463144", district: "Pathankot" },
  { name: "Tanish Kumar", age: 16, dob: "2010-07-19", phone: "7986569901", district: "Pathankot" },
  { name: "Ashok Kumar", age: 63, dob: "1963-06-16", phone: "9876257659", district: "Pathankot" },
  { name: "Raman Kumar", age: 39, dob: "1987-03-12", phone: "8968782718", district: "Pathankot" },
  { name: "Rajinder Pal", age: 60, dob: "1966-04-20", phone: "7837890674", district: "Pathankot" },
  { name: "Joginder Pal", age: 50, dob: "1976-01-01", phone: "9530682173", district: "Pathankot" },
  { name: "Amandeep Singh", age: 23, dob: "2003-04-12", phone: "9149905600", district: "Pathankot" },
  { name: "Sohan Lal", age: 48, dob: "1978-01-01", phone: "9878140525", district: "Pathankot" },
  { name: "Narinder Kumar", age: 53, dob: "1973-01-01", phone: "9646012637", district: "Pathankot" },
  { name: "Chaman Lal", age: 65, dob: "1961-01-01", phone: "9877811042", district: "Pathankot" },
  { name: "Vijay Kumar", age: 46, dob: "1980-10-02", phone: "8054970394", district: "Pathankot" },
  { name: "Rahul Kumar", age: 17, dob: "2009-05-08", phone: "9872410525", district: "Pathankot" },
  { name: "Sonu", age: 49, dob: "1977-09-19", phone: "9041042069", district: "Pathankot" },
  { name: "Vijay Kumar", age: 58, dob: "1969-01-01", phone: "9780576931", district: "Pathankot" },
  { name: "Ram Avtar", age: 52, dob: "1974-08-31", phone: "6006827954", district: "Pathankot" },
  { name: "Ram Chand", age: 61, dob: "1965-11-10", phone: "8968291181", district: "Pathankot" },
  { name: "Pishan Dass", age: 65, dob: "1961-01-01", phone: "7508625337", district: "Pathankot" },
  { name: "Sahib", age: 22, dob: "2004-10-27", phone: "9780404159", district: "Pathankot" },
  { name: "Saurav", age: 23, dob: "2003-03-27", phone: "8558860274", district: "Pathankot" },
  { name: "Rahul Kumar", age: 34, dob: "1992-09-16", phone: "7508646551", district: "Pathankot" },
  { name: "Surinder Kumar", age: 42, dob: "1984-05-19", phone: "9878580854", district: "Pathankot" },
  { name: "Mohan Lal", age: 52, dob: "1974-01-01", phone: "9876184325", district: "Pathankot" },
  { name: "Manik", age: 21, dob: "2005-01-27", phone: "7527999839", district: "Pathankot" },
  { name: "Raman Kumar", age: 41, dob: "1985-02-26", phone: "9780588170", district: "Pathankot" },
  { name: "Akunsh Kumar", age: 17, dob: "2009-12-13", phone: "9878580854", district: "Pathankot" },
  { name: "Roshan Lal", age: 68, dob: "1958-01-01", phone: "9646934561", district: "Pathankot" },
  { name: "Bishan Lal", age: 48, dob: "1978-01-01", phone: "9780722726", district: "Pathankot" },
  { name: "Anil Kumar", age: 52, dob: "1974-09-27", phone: "9988118995", district: "Pathankot" },
  { name: "Munish Kumar", age: 17, dob: "2009-11-11", phone: "6280095670", district: "Pathankot" },
  { name: "Karnail Chand", age: 69, dob: "1957-01-01", phone: "9781877402", district: "Gurdaspur" },
  { name: "Sarban Kumar", age: 47, dob: "1979-07-05", phone: "9622632473", district: "Jammu" },
  { name: "Lakhwinder Kumar", age: 39, dob: "1987-01-01", phone: "9465327383", district: "Hoshiarpur" },
  { name: "Raghuvir Singh", age: 71, dob: "1955-03-01", phone: "7355108546", district: "Pathankot" },
  { name: "Balkar Chand", age: 64, dob: "1962-01-01", phone: "9417695263", district: "Ludhiana" },
  { name: "Ram Lal", age: 45, dob: "1981-11-06", phone: "9498708531", district: "Pathankot" },
  { name: "Shamsher Singh", age: 65, dob: "1961-01-01", phone: "9855100734", district: "Jagraon" },

  // Page 2
  { name: "Chand Singh", age: 68, dob: "1958-01-01", phone: "9417096828", district: "Jagraon" },
  { name: "Sohan Singh", age: 65, dob: "1961-01-01", phone: "", district: "Jagraon" },
  { name: "Bhupinder Singh", age: 57, dob: "1969-10-05", phone: "9815983563", district: "Moga" },
  { name: "Niranjan Singh", age: 62, dob: "1964-01-01", phone: "9417255462", district: "Moga" },
  { name: "Pritam Singh", age: 66, dob: "1960-07-29", phone: "9815824012", district: "Ludhiana" },
  { name: "Sukhdev Singh", age: 78, dob: "1948-06-02", phone: "9988604122", district: "Ludhiana" },
  { name: "Harpal Singh", age: 59, dob: "1967-01-13", phone: "9217229177", district: "Ludhiana" },
  { name: "Narain Yadav", age: 62, dob: "1964-01-01", phone: "9417526556", district: "Ludhiana" },
  { name: "Pritam Singh", age: 77, dob: "1949-01-15", phone: "9781170043", district: "Ludhiana" },
  { name: "Santokh Dass", age: 63, dob: "1963-10-02", phone: "6280747681", district: "Ludhiana" },
  { name: "Mukand Singh", age: 62, dob: "1964-01-01", phone: "9914723721", district: "Ludhiana" },
  { name: "Balveer Singh", age: 45, dob: "1981-01-01", phone: "9814693850", district: "Ludhiana" },
  { name: "Maghar Singh", age: 50, dob: "1976-01-01", phone: "", district: "Ludhiana" },
  { name: "Hari Om", age: 60, dob: "1966-01-01", phone: "8872130558", district: "S.B.S. Nagar" },
  { name: "Raj Kumar", age: 65, dob: "1961-01-01", phone: "", district: "Hoshiarpur" },
  { name: "Vinod Kumar", age: undefined, dob: "", phone: "", district: "Pathankot" },
  { name: "Pawan Kumar", age: undefined, dob: "", phone: "", district: "Pathankot" },
  { name: "Ganesh Kumar", age: undefined, dob: "", phone: "", district: "Hoshiarpur" },
  { name: "Vikas Kumar", age: 35, dob: "1991-01-19", phone: "9805517640", district: "Kangra" },
