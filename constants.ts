...
const SUNDAY_LIST = ["Manish Munjal", "Surinder Raheja", "Parvesh Bhatia", "Amar Nath", "Ganpat Bhatia", "Ajit Singh", "Vinod Gaba", "Abhishek Chawla", "Anand Sharma", "Anil Kapoor", "Ankush Malik", "Arshit Raheja", "Ashish Rathore", "Ashok Harjai", "Ashok Kapoor", "Ashok Saini", "Ashok Sharma", "Atul Bansal", "B.B Khanna", "Baldev Gandhi", "Chaman Lal", "Dashrath Parsad", "Fakir Chand", "Gulshan Arora", "Harender Singh", "Harish Kumar", "Harvansh Verma", "Hemant", "Jai Kishan Arora", "Janak Raj Sharma", "Joginder Lal", "Kapil Budhiraja", "Kapil Mehndru", "Laxmi Chand", "Maange Ram", "Madan Gopal Sharma", "Madhuker Bhanot", "Madhusudan Malik", "Manmohan Arora", "Miras", "Mohak Bahel", "Parvesh Kumar", "Prem Gandhi", "Purshotam Gulati", "Rahul Gandhi", "Rajnish Kumar", "Rajnish", "Rakesh Gulati", "Rakshit Gupta", "Ram Chander", "Ramesh Chand", "Sachin Arora", "Sachin Budhiraja", "Sachin Verma", "Sahil Malik", "Sahil Tiwari", "Sailesh", "Sandeep Ahuja", "Sandeep Manocha", "Satish Saini", "Saurav", "Sheetal Parsad", "Shyam Murari", "Suraj Parkash", "Tarun Bhudiraja", "Tilak Raj", "Upender Parsad", "Ved Dua", "Vinod Kumar", "Vinod Kumar", "Vipin Khanna", "Vishal Dawar", "Yogesh Madan", "Prince", "S L Ojha"];
const MONDAY_LIST = ["Anil Gulati", "Dinesh Kapoor", "Angad Soni", "Aman Chauhan", "Ajit Singh", "Vinod Gaba", "Aakash Kumar", "Abhisekh Tyagi", "Abhishek Kumar", "Ajay Arora", "Aman Kapoor", "Aman Sharma", "Amit Kumar", "Anil Kumar", "Anil Verma", "Ankit Ahuja", "Ankit Gulati", "Ankit Rana", "Ankit Saluja", "Ankush Lamba", "Anmol Agrawal", "Anuj Soni", "Arun Kumar", "Aseem Kapoor", "Ashok Kumar", "Ashu", "Ashwani Narang", "Bharti Chugh", "Bobby Narang", "Brijmohan", "Deepak Takkar", "Devan Kathuria", "Devisharan", "Dimple(Sushil)", "Dinesh Salgotra", "Dr. Ravi Shastri", "D.L Kapoor", "Gagan", "Gagan (Montu)", "Gagan Arora", "Gagan Saluja", "Gurmeet Singh", "Gurvinder Singh", "Happy Bhutani", "Harish Dhingra", "Harish Malhotra(Rohtak)", "Inder Prakash", "Inderpal Singh", "Ishwar Lal", "Jagdish Saddana", "Jay Aprakash", "Kamal", "Karan Pal Singh", "Kartik Takkar", "Kastury Lal", "Kunal", "Lalman Pal", "Lekhraj", "Lokinder Singh", "Madan Baira", "Madan Gopal", "Mahender Kumar", "Mahender Bora", "Mahesh Aneja", "Man Singh", "Manish Sharma", "Manish Sharma(Rohtak)", "Manmohan Khurana", "Manoj Kumar", "Manoj Pal", "Mewa Ram", "Mohan Soni", "Monu", "Mukesh Kumar", "Narender Punyani", "Naresh Saini", "Naveen Kumar", "Naveen Sapra", "Nitender Kumar", "Om Prakash", "Om Prakesh (Vishwas Nag)", "Paras", "Paras Arora", "Paritosh Pal", "Pawan Khasa", "Pawan Sharma", "Pradeep Kumar", "Prem Chawala", "Prem Kumar", "Prem Singh", "Raj Kohli", "Rajan", "Rajender Bhati", "Rajender Singh", "Rajender Chawla", "Rajesh Manchanda", "Rajesh Pawar", "Rajesh Verma", "Rajinder Gandhi", "Rajkumar Dashturiya", "Rajkumar Malik", "Raju Gaba", "Raju Verma", "Rakesh Kumar", "Rakesh Madan", "Ram", "Ram Nivash", "Ramesh Chawla", "Rampal", "Randhir Singh", "Ranjeet Singh", "Rattan Dheeraj", "Ravinder", "Rohit Pal", "Ruchir Sharma", "Sachin Arora", "Sachin Wadhwa", "Sachin Yadav", "Sajjan Jain", "Sandeep Khanna", "Sanjay", "Sanjay Goutam", "Sanny Mittal", "Satish Sarma", "Shakti Kapoor", "Shivam Gandhi", "Shivam Singh", "Shwet Rathor", "Shyam Madan", "Shyam Sunder Chhabra", "S.N. Ojha", "Sonu Soni", "Sourav Takkar", "Subhash Dhingra", "Subhash Nandwani", "Sumit Chawla", "Sumit Sachdeva", "Sumit Sethi", "Sunder Singh", "Suneel Chawla", "Sunil Chawla", "Sunil Makhija", "Sunil Makkar", "Sunil Shadra", "Sunil Verma", "Sunil Kumar", "Sunny", "Suresh Pnp", "Sushil Chawla", "Sushil Garg", "Tarun", "Varun Verma", "Vicky", "Vikram Pal", "Vikram Singh Saini", "Vimal Singh", "Vinay Saini", "Vinod Khanna", "Vinod Khattar", "Vishnu Soni"];
...
export const FRIDAY_LIST = [
  ...
  "Jitender Arora", "Nanak Chand", "Rajinder Khurana", "Gulab Prasad", "Prem Lal", "Jitender Solanki", "Shiv Ram", "Anil Kumar", "Amit Verma", "Mohan Lal Gumber", "Sunil Nagpal", "Raju Soni"
];
