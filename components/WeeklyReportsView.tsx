      ...
      <div className="bg-gradient-to-r from-[#171e3d] via-[#101b33] to-[#0d1527] p-8 rounded-[2rem] text-white flex flex-col md:flex-row justify-between items-center gap-6 shadow-2xl relative overflow-hidden border border-indigo-400/20">
        <div className="relative z-10 flex-1">
          ...
          <p className="text-slate-300 text-xs font-normal max-w-xl leading-relaxed">
            Download verified till-date reports covering: (1) Top volunteers by hours and duty days; (2) Group standings by unique active volunteers with de-duplicated rosters; (3) Group rankings by total attendance submissions volume; and (4) Group active duty participation ratios calculated on both internal and all-groups totality basis.
          </p>
          {tillDateProgress && (
